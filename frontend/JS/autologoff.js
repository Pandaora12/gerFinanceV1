...
function generateCode() {
  ...
  // Configuração do Logoff Automático
  document.getElementById('save-autologoff-btn').addEventListener('click', () => {
    const selectedTime = document.getElementById('autologoff-time').value;
    localStorage.setItem('autologoffTime', selectedTime * 60 * 1000); // Salva em milissegundos
    alert(`Logoff automático configurado para ${selectedTime} minutos`);
  });
